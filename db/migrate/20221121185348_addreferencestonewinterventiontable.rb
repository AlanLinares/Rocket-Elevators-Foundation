class Addreferencestonewinterventiontable < ActiveRecord::Migration[5.2]
  def change
    ...
    add_reference :interventions, :battery, foreign_key: true, first: true
    ...
    add_reference :interventions, :employee, foreign_key: true, first: true
  end
end
